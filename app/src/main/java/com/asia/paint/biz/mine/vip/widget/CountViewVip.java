...
public class CountViewVip extends FrameLayout {
    ...
    public CountViewVip(@NonNull Context context) {
        this(context, null);
    }

    public CountViewVip(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountViewVip(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
