...
public class MineFragment extends BaseFragment<FragmentMineBinding> {
    ...
    private void updateMineData(MineDataRsp mineDataRsp) {
        ...
        // TODO: 2020/10/29  设置vip有效期
        //设置vip有效期
        mBinding.tvValidPeriod.setVisibility(View.GONE);
//        if (mineDataRsp.user.isVip()) {
//            mBinding.tvValidPeriod.setVisibility(View.VISIBLE);
//            mBinding.tvValidPeriod.setText("有效期2020-10-20");
//        }
