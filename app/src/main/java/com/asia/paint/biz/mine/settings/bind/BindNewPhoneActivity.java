package com.asia.paint.biz.mine.settings.bind;
 ...
 */
public class BindNewPhoneActivity extends BaseActivity<ActivityBindPhoneBinding> {
    private static final int MAX_COUNT = 100;
    private static final int MIN_COUNT = 0;
    public static final String KEY_BIND_NEW_PHONE = "KEY_BIND_NEW_PHONE";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding.tvSendSmsCode.setOnClickListener(new OnNoDoubleClickListener() {
            ...
            public void onNoDoubleClick(View view) {
                count = MAX_COUNT;
                setSmsCodeStatus(SmsCode.COUNT);
                mLoginViewModel.requestSmsCode(getPhone(), "changemobile");
            }
        });
        ...
        mBinding.tvNoSmsCode.setOnClickListener(new OnNoDoubleClickListener() {
            ...
            public void onNoDoubleClick(View view) {
                MessageDialog dialog = new MessageDialog.Builder()
                        ...
                        .build();
                dialog.show(BindNewPhoneActivity.this);
            }
        });
        ...
        mBinding.btnNext.setOnClickListener(new OnNoDoubleClickListener() {
            ...
            public void onNoDoubleClick(View view) {
                ...
                mLoginViewModel.bindNewPhone(phone, smsCode).setCallback(new OnChangeCallback<Boolean>() {
                    @Override
                    public void onChange(Boolean result) {
                        if (result) {
                            Intent intent = new Intent();
                            intent.putExtra(KEY_BIND_NEW_PHONE, phone);
