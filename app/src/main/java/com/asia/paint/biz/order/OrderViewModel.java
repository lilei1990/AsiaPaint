...
public class OrderViewModel extends BaseViewModel {
    ...
    public CallbackDate<CreateOrderRsp> createOrder(int flow_type, int address_id, int bonus_id, String description, int score) {
        NetworkFactory.createService(OrderService.class)
    ...
    public CallbackDate<CreateOrderRsp> createVipOrder(int flow_type, int address_id, int bonus_id, String description, int score, String receiptId) {
        NetworkFactory.createService(VipService.class)
                .createOrder(flow_type, address_id, bonus_id, description, score, receiptId)
                .compose(new NetworkObservableTransformer<>())
                .subscribe(new DefaultNetworkObserver<CreateOrderRsp>(false) {
    ...
    public CallbackDate<CreateOrderRsp> createVipOrder(int flow_type, int address_id, int bonus_id, String description, int i, int score, String sVipGoodSpecs) {
        NetworkFactory.createService(VipService.class)
                .createOrder(flow_type, address_id, bonus_id, description, score, sVipGoodSpecs)
                .compose(new NetworkObservableTransformer<>())
                .subscribe(new DefaultNetworkObserver<CreateOrderRsp>(false) {
                    @Override
                    public void onSubscribe(Disposable d) {
